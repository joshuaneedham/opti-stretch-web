    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="collapse navbar-collapse pull-right">
            <ul class="nav navbar-nav">
                ...
                <li class="{{ Request::segment(1) == 'book' ? 'active' : '' }}"><a href="/book"><span class="fa fa-fw fa-book"></span> Read The Book</a></li>
                @endif
                ...
                <li class="{{ Request::segment(1) == 'contact-us' ? 'active' : '' }}"><a href="/contact-us">Contact Us</a></li>
                @if (Auth::guest())
